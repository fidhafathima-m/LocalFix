...
export const toApplicationDetailDto = (
  ...
  const baseDto = toApplicationListDto(application);
...
const _mapPersonalInfo = (personal: any): ApplicationPersonalDto => {
  return {
...
const _mapSkills = (skills: any): SkillsDto => {
  return {
...
const _mapIdentity = (identity: any): IdentityDto => {
...
const _mapAvailability = (availability: any): ApplicationAvailabilityDto => {
...
const _mapBankDetails = (bank: any): BankDetailsDto => {
  return {
