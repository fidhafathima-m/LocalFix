...
export const toAddressDto = (address: IUserAddress): AddressDto => {
  return {
...
export const toAddressDtoList = (addresses: IUserAddress[]): AddressDto[] => {
  return addresses.map(toAddressDto); // Use the function directly
};

// Map create request to database model
export const toAddressCreateModel = (
...
export const toAddressUpdateModel = (data: any): Partial<IUserAddress> => {
