...
static toTechnicianProfileDto(
  ...
  private static mapPersonalInfo(technician: ITechnician, user: IUser): PersonalInfoDto {
    return {
  ...
  private static mapSkillsServices(technician: ITechnician): SkillsServicesDto {
    return {
      services: technician.services || SKILLS_DEFAULTS.SERVICES,
      experienceYears: technician.experienceYears || SKILLS_DEFAULTS.EXPERIENCE_YEARS,
  ...
  private static mapAvailabilityPreferences(technician: ITechnician): AvailabilityPreferencesDto {
    return {
