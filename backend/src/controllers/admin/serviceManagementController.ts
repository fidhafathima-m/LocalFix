...
export class ServiceManagementController {
  ...
  constructor(serviceService: IServiceService, logger: ILogger) {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : SERVICE_MESSAGES.FAILED_CREATE_SERVICE;
  ...
  updateService = async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : SERVICE_MESSAGES.FAILED_UPDATE_SERVICE;
  ...
  deleteService = async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : SERVICE_MESSAGES.FAILED_DELETE_SERVICE;
