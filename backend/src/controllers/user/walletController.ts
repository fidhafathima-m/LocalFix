...
export class WalletController {
  ...
  createAddMoneyOrder = async (req: AuthRequest, res: Response) => {
    const userId = req.user?.id;
  ...
  verifyAddMoneyPayment = async (req: AuthRequest, res: Response) => {
    const userId = req.user?.id;
  ...
  withdrawMoney = async (req: AuthRequest, res: Response) => {
    const userId = req.user?.id;
  ...
  addBankAccount = async (req: AuthRequest, res: Response) => {
    const userId = req.user?.id;
