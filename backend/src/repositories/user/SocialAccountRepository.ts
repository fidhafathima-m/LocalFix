import { ISocialAccount, ISocialAccountCreate } from '../../interfaces/user/ISocialAccount';
...
export class SocialAccountRepository {
  ...
  async findByUserIdAndProvider(userId: string | Types.ObjectId, provider: string): Promise<ISocialAccount | null> {
