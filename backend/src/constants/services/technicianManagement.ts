...
export const STATUS_MAPPING = {
  ...
  [TECHNICIAN_STATUS.UNDER_REVIEW]: TECHNICIAN_STATUS.PENDING,
  [TECHNICIAN_STATUS.PENDING]: TECHNICIAN_STATUS.PENDING,
  [TECHNICIAN_STATUS.APPROVED]: TECHNICIAN_STATUS.APPROVED,
  [TECHNICIAN_STATUS.ACTIVE]: TECHNICIAN_STATUS.APPROVED,
  [TECHNICIAN_STATUS.REJECTED]: TECHNICIAN_STATUS.REJECTED,
  [TECHNICIAN_STATUS.SUSPENDED]: TECHNICIAN_STATUS.SUSPENDED,
  [TECHNICIAN_STATUS.BLOCKED]: TECHNICIAN_STATUS.SUSPENDED,
} as const;
