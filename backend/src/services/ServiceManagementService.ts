...
export class ServiceService implements IServiceService {
  ...
  async createService(
    ...
    try {
      ...
      return this._serviceMapper.toServiceResponseDto(service);
    } catch (error) {
  ...
  async getServiceById(serviceId: string): Promise<ServiceResponseDto> {
    ...
    try {
      ...
      return this._serviceMapper.toServiceResponseDto(serviceWithCount);
    } catch (error) {
      const errorMessage = error instanceof Error ? error.message : "Unknown error occurred";
  ...
  async getServicesByCategoryId(
    ...
    try {
      ...
      if (search) {
        ...
        total = await this._serviceRepository.count({ categoryId: new Types.ObjectId(categoryId) });
      ...
      const result = this._serviceMapper.toServiceListResponseDto(
        servicesWithCounts,
        total,
        page,
        limit
  ...
  async getAllServices(
    ...
    try {
      ...
      if (search) {
        ...
        services = await this._serviceRepository.findAll({}, skip, limit, sortOptions);
  ...
  async updateService(
    ...
    try {
      ...
      return this._serviceMapper.toServiceResponseDto(updatedService);
    } catch (error) {
      const errorMessage = error instanceof Error ? error.message : "Unknown error occurred";
  ...
  async searchServices(
    ...
    try {
      ...
      return services.map((service) =>
        this._serviceMapper.toServiceResponseDto(service)
      );
    } catch (error) {
      const errorMessage = error instanceof Error ? error.message : "Unknown error occurred";
