...
export interface IPaymentRepository {
    ...
    updateByOrderId(orderId: string, updateData: Partial<IPayment>): Promise<IPayment | null>
    findByUserId(userId: string, page: number, limit: number): Promise<{ payments: IPayment[]; total: number }>
