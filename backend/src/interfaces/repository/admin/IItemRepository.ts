...
export interface IItemRepository {
  ...
  findAll(filter?: FilterQuery<IItem>, skip?: number, limit?: number): Promise<IItem[]>;
  update(itemId: string | Types.ObjectId, updateData: IItemUpdate): Promise<IItem | null>;
  ...
  searchByService(serviceId: string | Types.ObjectId, query: string, limit?: number): Promise<IItem[]>;
}