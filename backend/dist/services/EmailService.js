...
class EmailService {
    ...
    async sendApplicationApprovalEmail(technicianEmail, technicianName) {
    ...
    async sendApplicationRejectionEmail(technicianEmail, technicianName, rejectionReason) {
    ...
    async sendStatusUpdateEmail(technicianEmail, technicianName, newStatus, reason) {
    ...
    async sendTechnicianUnavailableNotification(customerEmail, customerName, technicianName, serviceDate, serviceType, orderId) {
