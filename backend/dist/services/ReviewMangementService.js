...
const reviewManagementMapper_1 = require("../mappers/reviewManagementMapper");
class ReviewManagementService {
    ...
    async getAllReviews(filters) {
        ...
        try {
            ...
            return {
                reviews: reviews.map(review => (0, reviewManagementMapper_1.toAdminReviewResponseDto)(review)),
                total,
                page: filters.page || 1,
                totalPages,
            };
    ...
    async getReviewById(reviewId) {
        ...
        try {
            ...
            if (!review) {
                ...
                throw new Error(constants_1.REVIEW_MESSAGES.REVIEW_NOT_FOUND);
            }
            this._logger.info('Review retrieved successfully', {
                ...context,
                reviewId: review._id?.toString(),
            });
            return (0, reviewManagementMapper_1.toAdminReviewResponseDto)(review);
        }
        catch (error) {
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
    ...
    async updateReviewStatus(reviewId, status) {
        ...
        try {
            ...
            if (!updatedReview) {
                ...
                throw new Error(constants_1.REVIEW_MESSAGES.FAILED_UPDATE_REVIEW);
            }
            ...
            return (0, reviewManagementMapper_1.toAdminReviewResponseDto)(reviewWithDetails);
        }
        catch (error) {
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
    ...
    async flagReview(reviewId, reason) {
        ...
        try {
            ...
            if (!updatedReview) {
                ...
                throw new Error(constants_1.REVIEW_MESSAGES.FAILED_FLAG_REVIEW);
            }
            const reviewWithDetails = await this._reviewRepository.findByIdWithDetails(reviewId);
    ...
    async deleteReview(reviewId) {
        ...
        try {
            ...
            if (!deleted) {
                ...
                throw new Error(constants_1.REVIEW_MESSAGES.FAILED_DELETE_REVIEW);
            }
