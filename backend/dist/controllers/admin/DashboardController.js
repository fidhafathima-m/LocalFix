    ...
    constructor(dashboardService, logger) {
        this.getDashboardOverview = async (req, res) => {
            ...
            try {
                ...
                const response = responseHelper_1.ResponseHelper.success('Dashboard overview retrieved', {
                    overview,
                });
        ...
        this.getRevenueTrend = async (req, res) => {
            ...
            try {
                ...
                const revenueTrend = await this._dashboardService.getRevenueTrend(period);
                this._logger.info('Revenue trend retrieved successfully', {
                    ...context,
                    dataPoints: revenueTrend.length,
                });
                const response = responseHelper_1.ResponseHelper.success('Revenue trend retrieved', {
                    revenueTrend,
                });
                res.status(response.statusCode).json(response);
            }
        ...
        this.getTopTechnicians = async (req, res) => {
            ...
            try {
                ...
                const topTechnicians = await this._dashboardService.getTopTechnicians(parseInt(limit) || 5);
                this._logger.info('Top technicians retrieved successfully', {
                    ...context,
                    count: topTechnicians.length,
                });
                const response = responseHelper_1.ResponseHelper.success('Top technicians retrieved', {
                    topTechnicians,
                });
                res.status(response.statusCode).json(response);
            }
        ...
        this.getCustomerSatisfaction = async (req, res) => {
            const context = {
            ...
            try {
                ...
                const customerSatisfaction = await this._dashboardService.getCustomerSatisfaction();
                this._logger.info('Customer satisfaction data retrieved successfully', {
                    ...context,
                    ratingsCount: customerSatisfaction.length,
                });
                const response = responseHelper_1.ResponseHelper.success('Customer satisfaction data retrieved', {
        ...
        this.getPaymentMethods = async (req, res) => {
            ...
            try {
                ...
                const response = responseHelper_1.ResponseHelper.success('Payment methods data retrieved', {
                    paymentMethods,
                });
                res.status(response.statusCode).json(response);
            }
        ...
        this.getGrowthMetrics = async (req, res) => {
            const context = {
            ...
            try {
                ...
                const response = responseHelper_1.ResponseHelper.success('Growth metrics retrieved', {
                    growthMetrics,
                });
                res.status(response.statusCode).json(response);
            }
        ...
        this.getCompleteDashboard = async (req, res) => {
            const context = {
            ...
            try {
                ...
                const response = responseHelper_1.ResponseHelper.success('Dashboard data retrieved successfully', dashboardData);
                res.status(response.statusCode).json(response);
            }
            catch (error) {
                const errorMessage = error instanceof Error
