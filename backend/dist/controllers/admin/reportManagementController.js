...
class ReportController {
    constructor(reportService, logger) {
        this.generateReport = async (req, res) => {
            ...
            try {
                ...
                if (!validFormats.includes(format)) {
                    const response = responseHelper_1.ResponseHelper.badRequest('Invalid format. Must be one of: pdf, csv, excel');
                ...
                if (parsedStartDate && parsedEndDate && parsedStartDate > parsedEndDate) {
                    const response = responseHelper_1.ResponseHelper.badRequest('Start date cannot be after end date');
                    res.status(response.statusCode).json(response);
                    return;
                }
                const reportRequest = {
                ...
                const response = responseHelper_1.ResponseHelper.success('Report generated successfully', result);
                res.status(response.statusCode).json(response);
            }
            catch (error) {
        ...
        this.generateFinancialReport = async (req, res) => {
            const context = {
            ...
            try {
                ...
                if (!startDate || !endDate) {
                    const response = responseHelper_1.ResponseHelper.badRequest('Start date and end date are required');
                    res.status(response.statusCode).json(response);
                    return;
                }
                ...
                const result = await this._reportService.generateFinancialReport(parsedStartDate, parsedEndDate);
                this._logger.info('Financial report generated successfully', {
                    ...context,
                    startDate: parsedStartDate,
                    endDate: parsedEndDate,
                });
                const response = responseHelper_1.ResponseHelper.success('Financial report generated successfully', result);
                res.status(response.statusCode).json(response);
            }
            catch (error) {
        ...
        this.generateCustomerReport = async (req, res) => {
            const context = {
            ...
            try {
                ...
                const result = await this._reportService.generateCustomerReport(parsedStartDate, parsedEndDate);
                this._logger.info('Customer report generated successfully', {
                    ...context,
                    startDate: parsedStartDate,
                    endDate: parsedEndDate,
                });
                const response = responseHelper_1.ResponseHelper.success('Customer report generated successfully', result);
                res.status(response.statusCode).json(response);
            }
            catch (error) {
                const errorMessage = error instanceof Error
        ...
        this.generateTechnicianReport = async (req, res) => {
            const context = {
            ...
            try {
                ...
                const result = await this._reportService.generateTechnicianReport(parsedStartDate, parsedEndDate);
                this._logger.info('Technician report generated successfully', {
                    ...context,
                    startDate: parsedStartDate,
                    endDate: parsedEndDate,
                });
                const response = responseHelper_1.ResponseHelper.success('Technician report generated successfully', result);
                res.status(response.statusCode).json(response);
            }
            catch (error) {
                const errorMessage = error instanceof Error
        ...
        this.exportReport = async (req, res) => {
            ...
            try {
                ...
                if (!data) {
                    const response = responseHelper_1.ResponseHelper.badRequest('Report data is required');
                    res.status(response.statusCode).json(response);
                    return;
                }
