...
const PaymentSuccess: React.FC = () => {
  ...
  const handleDownloadInvoice = () => {
    // In a real app, this would call an API to generate and download invoice
    const invoiceData = {
        ...
        <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-12">
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              We couldn't retrieve your booking details. Please check your bookings page.
            </p>
            <Link
              to="/bookings"
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h1 className="text-3xl font-bold mb-2">
              {state.paymentMethod === 'cod' ? 'Booking Confirmed!' : 'Payment Successful!'}
            </h1>
          ...
          <div className="border-t pt-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center py-2">
                ...
                <span className="font-semibold font-mono">{state.bookingId}</span>
              </div>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">{state.technician.displayName}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span className="font-semibold">
                  {state.technician.averageRating.toFixed(1)} ({state.technician.ratingCount} reviews)
                </span>
              </div>
              ...
              <div className="flex justify-between items-start py-2">
                ...
                <div className="text-right">
                  <div className="font-semibold">{formatDisplayDate(state.date)}</div>
                  <div className="text-sm text-gray-600">{formatDisplayTime(state.time)}</div>
                </div>
              </div>
              ...
              {state.paymentId && (
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold font-mono text-sm">{state.paymentId}</span>
                </div>
              )}
              ...
              {state.paymentMethod && (
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold capitalize">
                    {state.paymentMethod === 'cod' ? 'Cash on Delivery' : 'Online Payment'}
                  </span>
                </div>
              )}
