...
export const NOTIFICATION_ROUTES = {
  ...
  TECHNICIAN_MARK_AS_READ: (notificationId: string) => `/technician/notifications/${notificationId}/read`,
  ...
  ADMIN_MARK_AS_READ: (notificationId: string) => `/admin/notifications/${notificationId}/read`,
  ...
  CUSTOMER_MARK_AS_READ: (notificationId: string) => `/customer/notifications/${notificationId}/read`,
