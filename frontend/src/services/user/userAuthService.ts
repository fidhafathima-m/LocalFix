...
import { authAPI, type ForgotPasswordData, type GoogleAuthData, type LoginCredentials, type OTPData, type ResendOTPData, type ResetPasswordData, type SignupData } from "../common/authApi";
